...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/maintell/lx-music-android-tv#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/maintell/lx-music-android-tv/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/maintell/lx-music-android-tv/releases')
  }
  const openFAQPage = () => {
    void openUrl('https://lyswhut.github.io/lx-music-doc/mobile/faq')
  }
  // const openIssuesPage = () => {
  //   openUrl('https://github.com/maintell/lx-music-android-tv/issues')
  // }
  const openPactModal = () => {
    showPactModal()
  }
  const openPartPage = () => {
    void openUrl('https://github.com/maintell/lx-music-android-tv#%E9%A1%B9%E7%9B%AE%E5%8D%8F%E8%AE%AE')
  }
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <Focusable onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/maintell/lx-music-android-tv</Text>
        </Focusable>
      </View>
      <View style={styles.part}>
