...
const PlayPrevBtn = () => {
  ...
  return (
    <Focusable style={styles.cotrolBtn} activeOpacity={0.5} onPress={handlePlayPrev}>
...
const PlayNextBtn = () => {
  ...
  return (
    <Focusable style={styles.cotrolBtn} activeOpacity={0.5} onPress={handlePlayNext}>
...
const TogglePlayBtn = () => {
  ...
  return (
    <Focusable style={styles.cotrolBtn} activeOpacity={0.5} onPress={togglePlay}>
